...
set xlabel "source buffer size [bytes]" offset .5,0
set title "memcpy from buffer to 128KiB" offset 0,-.5  
#
#-------------------------------------------------------------------------------
# margins
#-------------------------------------------------------------------------------
...
'' u 1:($2+yhi):(labstr(diff($2,$3))) ls 3 not w labels offset 0.5,0 rotate by 45
